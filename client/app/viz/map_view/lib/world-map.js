// Modified by daniel 08/02/2014 to include custom label
...
jvm.WorldMap.prototype = {
  ...
  createCustomLabel: function(){
    ...
    this.customLabel = jvm.$('<div/>').addClass('jvectormap-custom-label').appendTo(jvm.$('body'));
